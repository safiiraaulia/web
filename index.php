...
<div class="content">
    <br><h2>Selamat datang di Sistem Manajemen Hospitality!</h2><br>
    <div class="row">
        <div class="col-md-6">
            <div class="card text-center">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title mt-2">Pasien</h5>
                    <p class="card-text">Kelola Pasien</p>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="card text-center">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title mt-2">Dokter</h5>
                    <p class="card-text">Kelola Dokter</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-6">
            <div class="card text-center">
                ...
                <div class="card-body">
                    ...
                    <h5 class="card-title mt-2">Janji Temu</h5>
                    <p class="card-text">Kelola Janji Temu</p>
                </div>
            </div>
        </div>
        <div class="col-md-6">
