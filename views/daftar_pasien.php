...
<div class="container">
            ...
            while($row = $result->fetch_assoc()) {
                echo "<tr>
                        ...
                        <td>
                            ...
                            <a href='../modules/hapus_pasien.php?id={$row['id']}' class='btn btn-danger' onclick='return confirmDelete()'>Hapus</a>
                        </td>
                    </tr>";
            }
        } else {
    ...
    <a href="../views/tambah_pasien.php" class="btn btn-primary mb-3" style="margin-left:500px;margin-right:400px;margin-top:30px;" >Tambah Pasien</a>
</div>
